  ...
  return (
    <Form
      ...
      <Form.Dropdown
        ...
        <Form.Dropdown.Item icon={{source: Icon.CircleFilled, tintColor: Color.Blue}} value="raycast-blue" title="Blue" />
        <Form.Dropdown.Item icon={{source: Icon.CircleFilled, tintColor: Color.Red}} value="raycast-red" title="Red" />
        <Form.Dropdown.Item icon={{source: Icon.CircleFilled, tintColor: Color.Green}} value="raycast-green" title="Green" />
        <Form.Dropdown.Item icon={{source: Icon.CircleFilled, tintColor: Color.Orange}} value="raycast-orange" title="Orange" />
        <Form.Dropdown.Item icon={{source: Icon.CircleFilled, tintColor: Color.Yellow}} value="raycast-yellow" title="Yellow" />
        <Form.Dropdown.Item icon={{source: Icon.CircleFilled, tintColor: Color.Magenta}} value="raycast-magenta" title="Magenta" />
        <Form.Dropdown.Item icon={{source: Icon.CircleFilled, tintColor: Color.Purple}} value="raycast-purple" title="Purple" />
      </Form.Dropdown>
      <Form.Dropdown
        id="icon"
        title="Icon"
